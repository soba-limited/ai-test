...
function init() {
  mvwrap = document.getElementById("mv");
  container = document.createElement("div");
  mvwrap.appendChild(container);
  if (container) {
  ...
  camera.position.z = 180; //This is how close or far the particles are seen
  ...
  var material = new THREE.SpriteCanvasMaterial({
    ...
    program: function (context) {
      context.beginPath();
      context.arc(1, -2, 0.1, 0, PI2, true);
      context.fill();
    },
  });
  ...
  renderer = new THREE.CanvasRenderer();
  var mv_w = document.getElementById("mv").clientWidth;
  var mv_h = document.getElementById("mv").clientHeight;
  renderer.setSize(mv_w, mv_h);
